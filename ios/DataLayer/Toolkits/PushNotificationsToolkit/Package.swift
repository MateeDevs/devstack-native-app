...
let package = Package(
    name: "PushNotificationsToolkit",
    platforms: [.iOS(.v14)],
    products: [
        // Products define the executables and libraries a package produces, and make them visible to other packages.
        .library(
            name: "PushNotificationsToolkit",
            targets: ["PushNotificationsToolkit"]
        )
    ],
    dependencies: [
    ...
    targets: [
        ...
        .testTarget(
            name: "PushNotificationsToolkitTests",
            dependencies: [
                "PushNotificationsToolkit",
                .product(name: "Utilities", package: "Utilities"),
                .product(name: "SharedDomain", package: "SharedDomain"),
                .product(name: "PushNotificationsProvider", package: "PushNotificationsProvider"),
                .product(name: "PushNotificationsProviderMocks", package: "PushNotificationsProvider")
            ],
            resources: [
